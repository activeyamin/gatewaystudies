...
@section('frontend_content')
    <section id="centennial_univer_part">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="schooling_visa_banner">
                <div class="img">
                    <img src="{{ asset('frontend_assets/images') }}/schooling_visa_banner.jpg" alt="schooling_visa_banner.jpg">
                </div>
        ...
        <div class="row mt-4">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="Centennial_fotter_details">
                    {{-- <h3 class="mt-4" style="font-weight:700; color:purple">Schooling Visa</h3> --}}
                    <p class="my-4">
                    ...
                    <div class="accordion" id="accordionPanelsStayOpenExample">
                        <div class="accordion-item">
                            ...
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                                <bold style="font-size: 18px; font-weight:600; color: purple">Schooling Visa</bold>
                            </button>
                            </h2>
