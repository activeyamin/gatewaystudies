    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-sm-12 col-lg-3 col-xl-4">
                <div class="Centennial_univer_logo_item">
                    <h3 style="font-weight:700; color:purple">Centennial College</h3>
                    <div class="img" style="width: 300px">
                        <img class="my-4" src="{{ asset('frontend_assets') }}/images/centennial_college.png" alt="centennial_college.png">
                    </div>
                    <br>
                    <a style="font-size: 18px; background: linear-gradient(45deg, #ff0a6ceb, #2e27fff1);" href="{{ route('discover.future.college') }}" class="btn text-white mt-2">Apply Now</a>
                </div>
            </div>
            <div class="col-sm-12 col-lg-8 col-xl-8">
                <div class="Centennial_video_bt_item">
                    <div class="img">
                        <img src="{{ asset('frontend_assets/images/centennial_college.png') }}" alt="centennial_college.png">
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="Centennial_fotter_details">
                    <h3 class="mt-4" style="font-weight:700; color:purple">About George Brown College</h3>
                    <p class="my-4">
                    ...
                    <div class="accordion" id="accordionPanelsStayOpenExample">
                        <div class="accordion-item">
                            ...
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                                <bold style="font-size: 18px; font-weight:600; color: purple">Why Centennial College</bold>
                            </button>
                            </h2>
